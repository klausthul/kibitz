...
// Generated by EnterpriseObjects palette at Sunday, December 11, 2005 10:57:41 AM Asia/Taipei
...
public class _GameWindow_EOArchive extends com.webobjects.eoapplication.EOArchive {
    ...
    protected void _construct() {
        ...
        if ((delegate != null) && ((replacement = delegate.objectForOutletPath(this, "promotionPiece")) != null)) {
            ...
            _eoFrame1 = (com.webobjects.eointerface.swing.EOFrame)_registered(new com.webobjects.eointerface.swing.EOFrame(), "PromotionPiece");
        }
        ...
        _nsButton3 = (javax.swing.JButton)_registered(new javax.swing.JButton("end"), "");
        _nsButton2 = (javax.swing.JButton)_registered(new javax.swing.JButton("next"), "");
        _nsButton1 = (javax.swing.JButton)_registered(new javax.swing.JButton("pre"), "");
        _nsButton0 = (javax.swing.JButton)_registered(new javax.swing.JButton("start"), "");
        _eoFrame0 = (com.webobjects.eointerface.swing.EOFrame)_registered(new com.webobjects.eointerface.swing.EOFrame(), "GameWindow");
    ...
    protected void _awaken() {
        ...
        if (_replacedObjects.objectForKey("_eoFrame1") == null) {
            _connect(_owner(), _eoFrame1, "promotionPiece");
        }

        if (_replacedObjects.objectForKey("_nsTextField2") == null) {
            _connect(_owner(), _nsTextField2, "serverInput");
        }
    ...
    protected void _init() {
        ...
        _nsTextField3.setText("Promote to:\n");
        ...
        _setFontForComponent(_nsTextField1, "Monaco", 36, Font.PLAIN);
        _nsTextField1.setEditable(false);
        _nsTextField1.setOpaque(true);
        _nsTextField1.setText("9:99:99.9");
        ...
        _setFontForComponent(_nsTextField0, "Monaco", 36, Font.PLAIN);
        _nsTextField0.setEditable(false);
        _nsTextField0.setOpaque(true);
        _nsTextField0.setText("9:99:99.9");
        ...
        _nsButton0.setSize(37, 33);
        _nsButton0.setLocation(799, 70);
        ...
        _nsButton1.setSize(37, 34);
        _nsButton1.setLocation(799, 109);
        ...
        _nsButton2.setSize(37, 33);
        _nsButton2.setLocation(799, 445);
        ...
        _nsButton3.setSize(37, 34);
        _nsButton3.setLocation(799, 484);
        ...
        _nsTextField0.setSize(251, 49);
        _nsTextField0.setLocation(586, 14);
        ...
        _nsTextField1.setSize(251, 49);
        _nsTextField1.setLocation(586, 525);
        ((EOViewLayout)_nsView0.getLayout()).setAutosizingMask(_nsTextField1, EOViewLayout.MinXMargin | EOViewLayout.MinYMargin);
        _nsView0.add(_nsTextField1);
        _nsTableView0.setSize(206, 446);
        _nsTableView0.setLocation(585, 71);
        ((EOViewLayout)_nsView0.getLayout()).setAutosizingMask(_nsTableView0, EOViewLayout.MinXMargin | EOViewLayout.HeightSizable);
        ...
        _nsTextField2.setSize(778, 27);
        _nsTextField2.setLocation(14, 713);
        ...
        ((EOViewLayout)_nsView0.getLayout()).setAutosizingMask(_nsButton8, EOViewLayout.MinXMargin | EOViewLayout.MinYMargin);
        _nsView0.add(_nsButton8);
        _nsView0.setSize(849, 754);
        _eoFrame0.setTitle("Window");
        _eoFrame0.setLocation(574, 96);
        _eoFrame0.setSize(849, 754);
    }
}
